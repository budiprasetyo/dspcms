...
<rss version="2.0"> 
<channel> 
<title>Modul Peraturan Feed</title> 
<link>http://www.peraturan.djpbn.depkeu.go.id</link> 
...
while($r=mysql_fetch_array($sql)){
  ...
  fwrite($file, "<item>
                 <title>$r[judul]</title>
                 <link>http://www.peraturan.djpbn.depkeu.go.id/berita-$r[id_berita]-$r[judul_seo].html</link>
